package edu.citytech.abccounter.counter;
...
public class GPExample extends Application {
    ...
    public void start(Stage primaryStage) throws Exception
    {
        ...
        primaryStage.setTitle("Counter Example ABC: Author: Itani, Manjil");
        GridPane gridPane = new GridPane();
        gridPane.setStyle("-fx-background-color: white; -fx-padding: 10 20 10;");
        ...
        for(Character character:abc){
            ...
            button.setStyle("-fx-border-color:black; -fx-padding:10 10 10 10;");
